...
file link:REDIS_AUTO_FAILOVER.rdoc).
...
* default message handler timeout is 10 minutes
...
* redis needs to be either version 1.0.7 or a version greater than 2.0.1 (2.0.0 does not
  work)
